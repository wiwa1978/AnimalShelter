    ...
    <div class="w-full flex justify-center mb-12">
        ...
        <div class="flex flex-wrap lg:flex-nowrap gap-4 lg:gap-8">
            <div class="rounded-3xl p-8 ring-1 xl:p-10 ring-gray-200 lg:w-1/3">
                <h3 id="tier-freelancer" class="text-center text-lg font-semibold leading-8 text-indigo-900">Pakket 'Brons'</h3>
            ...
            <div class="rounded-3xl p-8 ring-1 xl:p-10 ring-gray-200 lg:w-1/3">
                <h3 id="tier-startup" class="text-center text-lg font-semibold leading-8 text-indigo-900">Pakket 'Zilver'</h3>
            ...
            <div class="rounded-3xl p-8 ring-1 xl:p-10 ring-gray-200 lg:w-1/3">
                <h3 id="tier-freelancer" class="text-center text-lg font-semibold leading-8 text-indigo-900">Pakket 'Goud'</h3>
                <p class="mt-4 text-sm leading-6 text-gray-600">The essentials to provide your best work for clients.</p>
                <p class="mt-6 justify-center flex items-baseline gap-x-1 ">
                <!-- Price, update based on frequency toggle state -->
                 <!-- <span class="text-4xl font-bold tracking-tight text-rose-700">$15</span>-->
