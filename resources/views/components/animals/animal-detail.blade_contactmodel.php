        ...
        <div class="space-y-6 ">
            ...
            <div x-on:close-modal="showModal = false" x-data="{ isModalOpen: false }">
                <div class="grid grid-cols-2 gap-3 border border-gray-200 bg-white px-4 py-5 shadow sm:rounded-lg sm:px-6 text-center">
                    ...
                    <div>
                        <button x-on:click="isModalOpenNew = true" type="button" class="inline-flex items-center gap-x-2 rounded-md bg-rose-900 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                    ...
                    <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
                        <div 
                            ...
                            <div class="absolute right-0 top-0 hidden pr-4 pt-4 sm:block">
                                <button x-on:click="isModalOpenNew = false" type="button" class="rounded-md bg-white text-gray-400 hover:text-gray-500">
                            ...
                            <div class="pr-12 sm:flex sm:items-start">
                                ...
                                <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <div class="mt-6">
                                            <input wire:model="subject" name="subject" id="subject" class="pl-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-pink-900 sm:text-sm sm:leading-6" placeholder="Onderwerp">
                                        </div>
                            ...
                            <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                                <button @close-modal.window="isModalOpenNew = false" wire:click.prevent="sendMessageToOrganization({{ $animal }})" type="button" class="inline-flex w-full justify-center rounded-md bg-pink-900 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 sm:ml-3 sm:w-auto">Verzend</button>
                                <button x-on:click="isModalOpenNew = false" type="button" class="mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto">Cancel</button>
                            </div>
                ...
                <div  x-show="isModalOpen" x-transition:enter="ease-out duration-300" 
                    ...
                    <div 
                        ...
                        <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                            <button type="button" wire:click.prevent="redirectLogin({{ $animal->organization_id }})" class="inline-flex w-full justify-center rounded-md bg-rose-900 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-rose-900 sm:ml-3 sm:w-auto">Login</button>
