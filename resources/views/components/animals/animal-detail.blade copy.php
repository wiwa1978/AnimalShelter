...
<div class="mx-auto grid max-w-3xl grid-cols-1 gap-6 sm:px-6 lg:max-w-full lg:grid-flow-col-dense lg:grid-cols-3">
      ...
      <div  x-data="{ isModalOpen: false }" class="space-y-6 ">
        @if ( $animal_reserved)
        ...
        <section  class=" lg:col-span-1 lg:col-start-3">
            <div x-data="{ isModalOpen: false }" class="grid grid-cols-2 gap-3 border border-gray-200 bg-white px-4 py-5 shadow sm:rounded-lg sm:px-6 text-center">
                <div>
