<nav x-data="{ open: false }" class="relative bg-gray-50">
    ...
    <div class="flex h-16 items-center justify-between">
      <div class="flex items-center">
        <div class="flex-shrink-0">
          ...
          <img class="h-16 w-auto" src="{{ asset('storage/images/logo4.svg')}}" alt="Your Company">
        </div>
            ...
            <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
              ...
              <div class="relative ml-5 flex-shrink-0">
                ...
                <div x-show="open" class="absolute right-0 z-10 mt-2 w-64 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                  ...
                  <a wire:click="$refresh" wire:navigate href="{{ route('search-animal') }}" class="block px-4 py-2 text-base text-rose-700 rounded font-medium hover:bg-rose-700 hover:text-white" role="menuitem" tabindex="-1" id="user-menu-item-0">Alle dieren</a>
                  <hr class="my-2">
              ...
              <a wire:click="$refresh" wire:navigate class="rounded-md text-rose-700 px-3 py-2 text-xl font-medium hover:bg-rose-700 hover:text-white" href="#">Onze werking</a>
              <a wire:click="$refresh" wire:navigate href="{{ route('pricing') }}" class="rounded-md text-rose-700 px-3 py-2 text-xl font-medium hover:bg-rose-700 hover:text-white" >Prijzen</a>
